...
"use strict";
eval("\n\nvar _base = __webpack_require__(/*! ./Views/base */ \"./Views/base.js\");\n\nvar _Weather = __webpack_require__(/*! ./models/Weather */ \"./models/Weather.js\");\n\nvar _Weather2 = _interopRequireDefault(_Weather);\n\nvar _weatherView = __webpack_require__(/*! ./Views/weatherView */ \"./Views/weatherView.js\");\n\nvar weatherView = _interopRequireWildcard(_weatherView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n(0, _base.renderInfoOverlay)();\n\n/**\n * The Global app controller\n */\n// Import stylesheets\n//import './style.css';\n\nvar handleSearch = function handleSearch() {\n  //console.log('clicked');\n  var city = weatherView.getInput();\n  //console.log(city);\n  weatherView.clearResults();\n\n  (0, _base.renderLoader)(_base.elements.mainWeatherDiv);\n\n  _Weather2.default.fetchWeather(city, function (currentWeatherData) {\n    // console.log(data);\n    if (currentWeatherData) {\n      weatherView.renderMainWeatherData(currentWeatherData);\n      weatherView.renderWeatherDetails(currentWeatherData.details);\n      (0, _base.clearLoader)('overlay');\n      //Forecast \n\n      (0, _base.renderForecastLoader)();\n      _Weather2.default.fetchForecastWeather(city, function (forecastData) {\n        //console.log('in..');\n        if (forecastData) {\n          weatherView.renderForecastData(forecastData);\n          (0, _base.clearForecastLoader)();\n        } else {\n          (0, _base.clearForecastLoader)();\n          //Display error\n        }\n      });\n    } else {\n      (0, _base.clearLoader)('overlay');\n      // Display error\n    }\n  });\n};\n\nvar hideInfoOverlay = function hideInfoOverlay(e) {\n  // event bubbling \n  if (e.target.matches('.infoOverlay')) {\n    //console.log('matched...');\n    (0, _base.clearLoader)('infoOverlay');\n  }\n};\n\n// Attaching  event listener\n_base.elements.searchBtn.addEventListener('click', handleSearch);\n_base.elements.container.addEventListener('click', hideInfoOverlay);\n\n//# sourceURL=webpack:///./index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar convertUnixTimestampToJavascriptDate = exports.convertUnixTimestampToJavascriptDate = function convertUnixTimestampToJavascriptDate(unixTimeStamp) {\n  // Unixtimestamp\n  var unixtimestamp = unixTimeStamp;\n\n  // Months array\n  var months_arr = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];\n\n  // Convert timestamp to milliseconds\n  var date = new Date(unixtimestamp * 1000);\n\n  // Year\n  var year = date.getFullYear();\n\n  // Month\n  var month = months_arr[date.getMonth()];\n\n  // Day\n  var day = date.getDate();\n\n  // Hours\n  var hours = date.getHours();\n\n  // Minutes\n  var minutes = \"0\" + date.getMinutes();\n\n  // Seconds\n  var seconds = \"0\" + date.getSeconds();\n\n  // Display date time in MM-dd-yyyy h:m:s format\n  var convertedDateTime = month + '-' + day + '-' + year + ' ' + hours + ':' + minutes.substr(-2) + ':' + seconds.substr(-2);\n\n  return convertedDateTime;\n};\n\n//# sourceURL=webpack:///./utils/util.js?");
